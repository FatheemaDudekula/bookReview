...
public class BookReviewController {
	...
	@PutMapping("/update")
	public  ResponseEntity<Reviews> updateReview(@RequestBody Reviews review) throws Exception
	{
		Reviews reviewSaved=service.insertReview(review);
		mylogs.info("A value is updated ");
		return new ResponseEntity<Reviews> (reviewSaved,HttpStatus.CREATED) ;
	}
